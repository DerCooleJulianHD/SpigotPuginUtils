package src.de.dercoolejulianhd.plugin.utils.config;
...
public abstract class Configuration {
    ...
    public static org.apache.logging.log4j.Logger logger = LogManager.getLogger(Configuration.class);

    private final Plugin plugin;
    private final File file, dir;
    private FileConfiguration fileConfiguration;

    private final Map<ConfigurationSection, Map<String, Object>> defaults;

    public Configuration(Plugin plugin, File dir, String fileName, boolean loadOnInit) {
        this.plugin = plugin;
        this.dir = dir;
    ...
    public void createConfigFiles() {
        ...
        try {
            ...
            Configuration.logger.log(org.apache.logging.log4j.Level.ERROR, ex);
        }
    }
    ...
    public void load() {
        this.onLoad();
        try {
            this.fileConfiguration = new YamlConfiguration(); /* load */
    ...
    private void setDefaults() {
        ...
        for (ConfigurationSection section : this.defaults.keySet()) {
            Map<String, Object> values = this.defaults.get(section);
            if (section == null) continue;

            if (fileConfiguration.getConfigurationSection(section.getCurrentPath()) == null) fileConfiguration.createSection(section.getCurrentPath());
    ...
    /**
     * Description: adds a default value nad will be set by calling setDefaults() method.
     */
    @Description("  /* adds a default value nad will be set by calling setDefaults() method. */  ")
    public void setDefault(ConfigurationSection section, Map<String, Object> values) {
        this.defaults.put(section, values);
    }


    /**
     * Description: removes a default value.
     */
    @Description("  /* removes a default value */  ")
    public void removeDefault(ConfigurationSection section) {
        if (!this.defaults.containsKey(section)) return;
        this.defaults.remove(section);
    }
